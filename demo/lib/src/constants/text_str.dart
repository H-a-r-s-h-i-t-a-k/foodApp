...
const String mLoginPagetitle = "Take Delisious Food App";
const String mLoginSubPagetitle = "Savor the Best of Chinese Cuisine";

const String mSignUpPagetitle = "Take Delisious Food App";
...
const String mforgotpassTitle = "Delisious Food App ";
